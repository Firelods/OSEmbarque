...
#      LINK (NO LTO)
# ------------------------
$(BUILD_DIR)/$(PROGRAM).elf: Build/timers.o Build/tasks.o Build/queue.o \
                             Build/list.o Build/croutine.o Build/heap_1.o \
                             Build/port.o Build/Wire.o Build/twi.o \
                             Build/ir.o Build/servo.o Build/lcd_grove.o \
                             Build/main.o
